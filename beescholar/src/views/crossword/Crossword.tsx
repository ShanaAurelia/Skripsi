...
class CrosswordPage extends Component<ICrosswordProps, ICrosswordState> {
  ...
  setCrosswordComplete = () => {
    this.setState({ isCrosswordComplete: true });
  };

  render() {
    const { isCrosswordComplete, isCrosswordCorrect, openModal } = this.state;
        ...
        <div
          ...
          <CrosswordProvider
            ...
            onCrosswordComplete={(correct) =>
              correct && !isCrosswordComplete ? this.setCrosswordComplete() : {}
            }>
            <div
              id='crossword'
